...
from .utilities import I18N, Logger, Prompts, RPMController
...
class Agent(BaseModel):
    ...
    Attributes:
            ...
            response_callback: A callback function to be called for any message
    """
    ...
    response_callback: Optional[Any] = Field(
        default=None, description="A callback function to be called for any message"
    )

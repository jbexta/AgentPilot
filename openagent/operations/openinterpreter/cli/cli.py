...
arguments = [
    ...
    },
    {
        "name": "auto_run",
        "nickname": "y",
        "help_text": "automatically run the openinterpreter",
        "type": bool
    },
    {
        "name": "debug_mode",
...
def cli(interpreter):
    ...
    # Set attributes on openinterpreter
    for attr_name, attr_value in vars(args).items():
        # Ignore things that aren't possible attributes on openinterpreter
    ...
    if args.fast:
        ...
        print("`openinterpreter --fast` is depracated and will be removed in the next version. Please use `openinterpreter --model gpt-3.5-turbo`")

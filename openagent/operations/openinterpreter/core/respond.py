...
def respond(interpreter):
    """
    Yields tokens, but also adds them to openinterpreter.messages. TBH probably would be good to seperate those two responsibilities someday soon
    ...
    while True:
        ...
        # Add a new message from the assistant to openinterpreter's "messages" attribute
        ...
        if "code" in interpreter.messages[-1]:
            ...
            try:
                ...
                # Get a code openinterpreter to run it

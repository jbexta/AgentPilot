...
language_map = {
  "python": {
    # Python is run from this openinterpreter with sys.executable
    # in interactive, quiet, and unbuffered mode
    "start_cmd": sys.executable + " -i -q -u",
    "print_cmd": 'print("{}")'
  },
  "R": {
    # R is run from this openinterpreter with R executable
    # in interactive, quiet, and unbuffered mode
...
"""
with open("openinterpreter/forbidden_commands.json", "r") as f:

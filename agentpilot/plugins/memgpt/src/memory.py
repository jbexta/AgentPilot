...
from agentpilot.plugins.memgpt.src.embeddings import embedding_model
from agentpilot.plugins.memgpt.src.config import MemGPTConfig
...
class EmbeddingArchivalMemory(ArchivalMemory):
    ...
    def __init__(self, agent_config, top_k: Optional[int] = 100):
        ...
        :type archival_memory_database: str
        """
        from agentpilot.plugins.memgpt.src.connectors.storage import StorageConnector
    ...
    def insert(self, memory_string):
        ...
        from agentpilot.plugins.memgpt.src.connectors.storage import Passage

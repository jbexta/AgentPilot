...
from agentpilot.plugins.crewai.src.agents import (
    CacheHandler,
    CrewAgentExecutor,
    CrewAgentOutputParser,
    ToolsHandler,
)
from agentpilot.plugins.crewai.src.utilities import I18N, Logger, Prompts, RPMController
...
class Agent(BaseModel):
    ...
    # CUSTOM ARG
    response_callback: Any = Field(
        default=None,
        description="A callback method that will be called when the agent responds.",
    )

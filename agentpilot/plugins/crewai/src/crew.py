...
from agentpilot.plugins.crewai.src.agent import Agent
from agentpilot.plugins.crewai.src.agents.cache import CacheHandler
from agentpilot.plugins.crewai.src.process import Process
from agentpilot.plugins.crewai.src.task import Task
from agentpilot.plugins.crewai.src.tools.agent_tools import AgentTools
from agentpilot.plugins.crewai.src.utilities import I18N, Logger, RPMController
...
class Crew(BaseModel):
    ...
    def _sequential_loop(self) -> str:
        ...
        for task in self.tasks:
            ...
            task.agent.response_callback(task_output)
